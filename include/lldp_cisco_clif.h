...
#ifndef _LLDP_CISCO_CLIF_H
#define _LLDP_CISCO_CLIF_H

struct lldp_module *cisco_cli_register(void);
void cisco_cli_unregister(struct lldp_module *);
int cisco_print_tlv(u32, u16, char *);

#endif /* _LLDP_CISCO_CLIF_H */
